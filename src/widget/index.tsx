...
function Widget() {
    ...
    const cheese = useCustomWidgetOptionString(client, 'favorite-cheese');
    ...
    return (
        <section style={{ padding: '10px' }}>
            ...
            <p>
                Your favorite cheese is: <strong>{cheese}</strong>
            </p>
            <p>
                My template variable is: <strong>{ipAddress}</strong>
            </p>
            <p>
